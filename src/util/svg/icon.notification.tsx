...
export const NotificationMentionIcon = (props: SvgProps) => (
...
export const NotificationPostedIcon = (props: SvgProps) => (
...
export const NotificationUpdateIcon = (props: SvgProps) => (
...
export const NotificationPollIcon = (props: SvgProps) => (
	<Svg
		fill="#FF3C26"
		stroke="#FF3C26"
...
export const NotificationEmptyIcon = (props: SvgProps) => (
	<Svg
		width="70px"
		height="70px"
		viewBox="0 0 512 512"
